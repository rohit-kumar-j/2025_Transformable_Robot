__credits__ = ["Kallinteris-Andreas,Rohit-Jakkula"]
...
class SingleModuleWorldEnv(MujocoEnv, utils.EzPickle):
    r"""
    ## Description
    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._angular_vel_reward_weight = angular_vel_reward_weight
        ...
        xml_file = "1_snake_forward_ft_final.xml"
        FILE_PATH = os.path.join(os.path.dirname(__file__), "urdf", xml_file)
        print("xml_file: ", FILE_PATH)
